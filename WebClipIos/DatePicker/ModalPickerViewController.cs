...
namespace SharpMobileCode.ModalPicker
{
    ...
    public class ModalPickerViewController : UIViewController
    {
		...
		public UIDatePicker TimePicker { get; set; }
            ...
            set
            {
                switch(value)
                {
					...
					case ModalPickerType.Time:
						TimePicker = new UIDatePicker(CGRect.Empty);
						TimePicker.Mode = UIKit.UIDatePickerMode.Time;
						PickerView = null;
						DatePicker = null;
						break;
          ...
          //  View.BackgroundColor = UIColor.Clear;
            ...
            switch(PickerType)
            {
				...
				case ModalPickerType.Time:
					...
					_internalView.AddSubview(TimePicker);
					break;
                case ModalPickerType.Custom:
        ...
        void Show(bool onRotate = false)
        {
            ...
            switch(_pickerType)
            {
                case ModalPickerType.Date:
                    ...
                    break;
				case ModalPickerType.Time:
					internalViewSize = new CGSize(width, TimePicker.Frame.Height + _headerBarHeight);
					break;
                case ModalPickerType.Custom:
            ...
            switch(_pickerType)
            {
                case ModalPickerType.Date:
					...
					break;
				case ModalPickerType.Time:
					TimePicker.Frame = new CGRect(TimePicker.Frame.X, _headerBarHeight, _internalView.Frame.Width,
													  TimePicker.Frame.Height);
                    break;
                case ModalPickerType.Custom:
